...
exports.handler = async (event) => {
  ...
  console.log('SUPABASE_DB_URL:', process.env.SUPABASE_DB_URL ? 'SET (length: ' + process.env.SUPABASE_DB_URL.length + ')' : 'NOT SET');
  ...
  try {
    ...
    if (SUPABASE_URL && SUPABASE_SERVICE_ROLE) {
      ...
      console.log('Cannot create Supabase client - missing URL or service role');
    }
